	...
	public static void main (String[] args){
		try{
			...
			for(int i = 0; i < elementosRastreo.length; i++){
				...
				System.out.print(elementosRastreo[i].getClassName() + "\t");
				System.out.print(elementosRastreo[i].getFileName() + "\t");
				System.out.print(elementosRastreo[i].getLineNumber() + "\t");
				System.out.print(elementosRastreo[i].getMethodName() + "\n");
			}
		}
	}
